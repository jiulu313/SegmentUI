...
//    private ActionBarMenu actionMode;
    ...
    protected Segment parentFragment;
    ...
    private void createBackButtonImage() {
        ...
        backButtonImageView.setPadding(SAppUtil.dp(getContext(),1), 0, 0, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int actionBarHeightSpec = View.MeasureSpec.makeMeasureSpec(actionBarHeight, View.MeasureSpec.EXACTLY);

        setMeasuredDimension(width, actionBarHeight + (occupyStatusBar ? AndroidUtilities.statusBarHeight : 0) + extraHeight);

        int textLeft;
        if (backButtonImageView != null && backButtonImageView.getVisibility() != GONE) {
            backButtonImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(54), View.MeasureSpec.EXACTLY), actionBarHeightSpec);
        ...
        if (menu != null && menu.getVisibility() != GONE) {
            int menuWidth;
            if (isSearchFieldVisible) {
                menuWidth = View.MeasureSpec.makeMeasureSpec(width - AndroidUtilities.dp(AndroidUtilities.isTablet() ? 74 : 66), View.MeasureSpec.EXACTLY);
            } else {
                menuWidth = View.MeasureSpec.makeMeasureSpec(width, View.MeasureSpec.AT_MOST);
            }
        ...
        if (titleTextView != null && titleTextView.getVisibility() != GONE || subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
            ...
            if (titleTextView != null && titleTextView.getVisibility() != GONE) {
                ...
                titleTextView.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24), View.MeasureSpec.AT_MOST));
            ...
            if (subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                ...
                subtitleTextView.measure(View.MeasureSpec.makeMeasureSpec(availableWidth, View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20), View.MeasureSpec.AT_MOST));
            }
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            measureChildWithMargins(child, widthMeasureSpec, 0, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), View.MeasureSpec.EXACTLY), 0);
        }
    }
